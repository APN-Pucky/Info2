...
public class Aufgabe36 {
	 ...
	 * 
	 * @param node
	 *            der Wurzelknoten des betrachteten (Teil-)Baums
	 * @param a
	 *            int-array, in dem die Werte der Knoten abgelegt werden sollen
	 *            (Achtung: Array muss so viele Eintraege haben wie Knoten im
	 *            Baum sind)
	 * @param pos
	 *            aktuelle Array-Position (0 fuer Aufruf mit der Wurzel des
	 *            gesamten Baums)
