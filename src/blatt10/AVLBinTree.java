...
public class AVLBinTree<E extends Comparable<E>> {
	...
	/**
	 * Konstruktor: Legt einen leeren binaeren Baum an.
	 */
	public AVLBinTree() {
	}

	/**
	 * Fuegt ein neues Element hinzu und rekonstruiert den Baum.
	 * 
	 * @param elem
	 *            neues Element
	 */
		...
		if (root == null) {
			...
			while (cur != null) {
				...
				if (cur.getBalance() == 0) {
					...
					// System.out.println("LO:" + last_orient + " " +
	...
	public void delete(E elem) {
		...
		do {
			...
			if (elem.compareTo(cur.getValue()) < 0) {
				...
				AVLBinTreeNode<E> n, n_child, n_tmp;
				if (cur.isLeaf()) {
					if (cur == root) {
						root = null;
						n = null;
	...
	/**
	 * Gibt zurueck, ob der Baum ein Element mit demselben Wert enthaelt.
	 * 
	 * @param elem
	 *            zu pruefendes ELement
	...
	/**
	 * Rotiert doppelt (rechts und links) um einen Teilbaum.
	 * 
	 * @param a
	 *            Teilbaum
	 */
	...
	/**
	 * Rotiert doppelt (links und rechts) um einen Teilbaum.
	 * 
	 * @param a
	 *            Teilbaum
	 */
	...
	/**
	 * Rotiert links um einen Teilbaum.
	 * 
	 * @param a
	 *            Teilbaum
	 */
	...
	/**
	 * Rotiert rechts um einen Teilbaum.
	 * 
	 * @param a
	 *            Teilbaum
	 */
