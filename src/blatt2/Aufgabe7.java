...
public class Aufgabe7 
{
	...
	/**
	 * Testet die iterative Fibonacci Methode und gibt das Ergebniss von fib(n) zurück
	 * @param n fib-Index
	 */
	...
	/**
	 * Testet die modulare Fibonacci Methode und gibt das Ergebniss von fib(n) zurück
	 * @param n fib-Index
	 */
	private static void testModFib(int n)
	{
		...
		System.out.println("iterFib2[" +n +"]= {" + value_iter[0] + ", " + value_iter[1] + ", " + value_iter[2] + "} = " + value_int);
	}
	
	/**
	 * Testet mehrere fib-Indizes rekursiv
	 * @param tests Array der Indizes
	 */
	private static void testRecFibArray(int[] tests)
	{
		for(int i : tests)testRecFib(i);
	}
	...
	{
		for(int i : tests)testModFib(i);
	}
	/**
	 * Gibt den Index der hoechsten Fibonacci-Zahl aus, die sich noch unter max befinded.
	 * @param max Obere Grenze fuer Fibonaccizahlen
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Hoechste Fibonacci-Zahl mit modularer Arithmetik[Index:" + getHighestFibIndexBelow(MAX_MODULAR_VALUE)+ "]: " + iterativeFib((short)getHighestFibIndexBelow(MAX_MODULAR_VALUE)));
	}
}
