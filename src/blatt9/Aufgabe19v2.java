...
/**
 * Rahmen zur Aufgabe 19. Verwendet ein (privates) Visualizer-Objekt, um die
...
public class Aufgabe19v2 {
	...
	/**
	 * Zaehlt einen Countdown herunter und zeigt diesen auch an. Erwartet, dass
	 * das Visualizer-Objekt v gesetzt ist.
	 * 
	 * @param seconds
	 *            Laenge des Countdowns.
	 */
	...
	private static void reset(int[] a) {
		...
		Visualizer.sleepRealtime(1500);
		String s = "Read-OPs: " + read_count + " | Write-OPs: " + write_count + " | Swaps: " + write_count / 2 + "("
				+ swap_count + ")" + " | Comps.: " + (read_count - write_count) / 2 + "(" + compare_count + ")"
				+ " | Guetekriterium: " + (write_count + (read_count - write_count) / 2);
		v.setLegend(s);
		System.out.println(s);
		v.repaint();
		Visualizer.sleepRealtime(3000);
	...
	/**
	 * Hilfstauschmethode tauscht Werte von a[b] und a[c]
	 * 
	 * @param a
	 *            Array
	 * @param b
	...
	/**
	 * Schreibt einen Wert an einer Stelle in ein Array. Dabei wird ein
	 * Schreibzugriff gezaehlt.
	 * 
	 * @param a
	 *            Array
	 * @param b
	...
	/**
	 * Gibt den Wert an einer Stelle in einem Array zurueck. Dabei wird ein
	 * Lesezugriff gezaehlt.
	 * 
	 * @param a
	 *            Array
	 * @param b
	 *            Index
	 * @return Wert des Arrays beim Index
	 */
	...
	/**
	 * Vergleicht zwei Werte und gibt zurueck, ob der erste kleiner als der
	 * zweite ist. Dabei wird ein Vergleichszugriff gezaehlt.
	 * 
	 * @param b
	 *            erster Wert
	 * @param c
	...
	/**
	 * Vergleicht zwei Werte und gibt zurueck, ob der erste groesser als der
	 * zweite ist. Dabei wird ein Vergleichszugriff gezaehlt.
	 * 
	 * @param b
	 * @param c
	...
	/**
	 * Sortiert ein int-Array mit dem Bubble-Sort Algorithmus (Code siehe
	 * Aufgabe 20) und visualisiert dies mit Hilfe eines (statischen)
	 * Visualizer-Objekts v, welches existieren muss.
	 * 
	 * @param a
	 *            das zu sortierende Array
	 * 
	 * @throws IllegalStateException
	 *             falls das Visualizer-Objekt nicht existiert
	 */
	public static void visualBubbleSort(int[] a) {
		...
		do {
			...
			for (int i = 0; i < a.length - run; i++) {
				v.setLabel(i, "i");
				v.setHighlight(i, Visualizer.VERTICAL_HIGHLIGHT);
				...
				Visualizer.sleep(2); // und warten
				v.setLabel(i, "");
				v.setHighlight(i, Visualizer.NO_HIGHLIGHT);
				if (i == a.length - run - 1)
	...
	/**
	 * Sortiert ein int-Array mit dem Insertion-Sort Algorithmus (Code siehe
	 * Aufgabe 20) und visualisiert dies mit Hilfe eines (statischen)
	 * Visualizer-Objekts v, welches existieren muss.
	 * 
	 * @param a
	...
	/**
	 * Sortiert ein int-Array mit dem Selection-Sort Algorithmus (Code siehe
	 * Aufgabe 20) und visualisiert dies mit Hilfe eines (statischen)
	 * Visualizer-Objekts v, welches existieren muss.
	 * 
	 * @param a
	...
	public static void visualSelectionSort(int[] a) {
		...
		for (int i = 0; i < a.length - 1; i++) {
			...
			for (int j = i + 1; j < a.length; j++) {
				if (smallerThan(get(a, j), get(a, minind)))
					minind = j;
			}
			swap(a, i, minind);
	...
	/**
	 * Sortiert ein int-Array mit dem Merge-Sort Algorithmus (Code siehe Aufgabe
	 * 20) und visualisiert dies mit Hilfe eines (statischen) Visualizer-Objekts
	 * v, welches existieren muss.
	 * 
	 * @param a
	 *            das zu sortierende Array
	 * 
	...
	/////////////////////////////////////////////
	/**
	 * Sortiert ein int-Array mit dem Quick-Sort Algorithmus (Code siehe Aufgabe
	 * 20) und visualisiert dies mit Hilfe eines (statischen) Visualizer-Objekts
	 * v, welches existieren muss.
	 * 
	 * @param a
	...
	/**
	 * Sortiert ein int-Array mit dem Quick-Insert-Sort Algorithmus (Code siehe
	 * Aufgabe 20) und visualisiert dies mit Hilfe eines (statischen)
	 * Visualizer-Objekts v, welches existieren muss.
	 * 
	 * @param a
	...
	/**
	 * Sortiert ein int-Array mit dem Quick-Insert-Sort Algorithmus (Code siehe
	 * Aufgabe 20) ohne es zu visualisieren.
	 * 
	 * @param a
	 *            Array
	 * @param l
